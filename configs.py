...
class Config:
    ...
    BOT_TOKEN = getenv("BOT_TOKEN", "7888840713:AAF9yJpS-RbdxTYAOFXsTyCIU4vsLejTTh0")

    # Admin / Owner IDs (space-separated)
    SUDO = list(map(int, getenv(
        "SUDO",
        "7554081592 7563827554 7564050858 5656436152"
    ).split()))
    ...
    # Posts to copy
    POSTS = [
        "https://t.me/forward_hack_lnx/132",
        "https://t.me/forward_hack_lnx/133",
        "https://t.me/forward_hack_lnx/139"
    ]
